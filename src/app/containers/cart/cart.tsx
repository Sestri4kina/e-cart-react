...
class CartView extends React.Component<CartViewProps, {}> {
  render() {
    ...
    return (
      <>
        <h1 className="marg-left-lg marg-top-md" data-testid="cart-title">
          Cart
        </h1>
        {isLoaded && (
          <>
            <div
              className="grid-container-rows"
...
export const Cart = connect<
  Pick<CartViewProps, "cartItemsWithStock" | "isLoaded" | "total" | "error">,
...
>(
  ...
  (dispatch: AppStore["dispatch"]) => ({
    onUpdateItem: (itemId: string, quantity: number) =>
